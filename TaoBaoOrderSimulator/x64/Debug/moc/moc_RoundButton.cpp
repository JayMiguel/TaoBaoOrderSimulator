...
#include <memory>
#include "../../../Src/ui/common/RoundButton.h"
...
#define QT_MOC_LITERAL(idx, ofs, len) \
    ...
    qptrdiff(offsetof(qt_meta_stringdata_RoundButton_t, stringdata0) + ofs \
        - idx * sizeof(QByteArrayData)) \
    )
static const qt_meta_stringdata_RoundButton_t qt_meta_stringdata_RoundButton = {
    {
QT_MOC_LITERAL(0, 0, 11) // "RoundButton"
...
QT_INIT_METAOBJECT const QMetaObject RoundButton::staticMetaObject = { {
    QMetaObject::SuperData::link<QPushButton::staticMetaObject>(),
    qt_meta_stringdata_RoundButton.data,
    qt_meta_data_RoundButton,
    qt_static_metacall,
    nullptr,
    nullptr
} };
...
void *RoundButton::qt_metacast(const char *_clname)
{
    ...
    if (!strcmp(_clname, qt_meta_stringdata_RoundButton.stringdata0))
